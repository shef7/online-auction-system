		...
		<div class="card">
			<div class="card-body">
				<form action="" id="manage-product">
					...
					<label for="" class="control-label">Click the  button for predicting the price of your item</label>

					<button onclick="openAppPyWebsite()">Prediction Analysis</button>

    <script>
        function openAppPyWebsite() {
            var appPyUrl = 'http://127.0.0.1:5000/'; // Replace with the actual URL of your app.py website
            window.open(appPyUrl, '_blank');
        }
    </script>
					</div>
